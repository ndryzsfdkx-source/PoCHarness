...
def main():
    ...
    # Prefer the loose report emitted by the multi-grader pipeline, with the
    # deprecated compatibility alias as fallback for older runs.
    report_file = os.path.join(args.input_dir, f"report_loose_{args.agent}.jsonl")
